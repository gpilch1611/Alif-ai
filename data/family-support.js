...
export const FAMILY_REASSURANCE_POINTS = [
  {
    ...
    bodyPl:
      "Konwersja nie musi oznaczać odrzucenia domu, języka ani rodziny. Islam uczy dobroci wobec rodziców, nawet gdy nie podzielają wiary.",
    bodyEn:
      "Conversion does not need to mean rejecting home, language or family. Islam teaches kindness to parents even when they do not share the faith.",
...
export const FAMILY_CONVERSATION_GUIDE = [
  ...
  },
  {
    ...
    textEn:
      "Islam does not allow me to despise my parents. I want to be better, calmer and more responsible toward you."
  },
  {
    id: "pace",
    ...
    textEn:
      "You do not need to understand everything today. I am also learning step by step. We can talk without pressure."
  }
];

export const FAMILY_PARENT_FAQ = [
  {
    id: "family-contact",
...
export const FAMILY_PARENT_FACTS = [
  {
    id: "still-your-child",
    icon: "💚",
  ...
  },
  {
    id: "no-cutting-ties",
    icon: "🤝",
    titlePl: "Islam nie wymaga zerwania więzi",
    titleEn: "Islam does not require cutting ties",
    bodyPl: "Dobre traktowanie rodziców i bliskich pozostaje ważne, nawet gdy rodzina nie podziela wiary.",
    bodyEn: "Good treatment of parents and loved ones remains important, even when family does not share the faith.",
    notePl: "Bliskość",
    noteEn: "Closeness"
  },
  {
...
export const FAMILY_PARENT_RESOURCES = [
  {
    id: "calm-talk",
  ...
  {
    id: "polish-sources",
    labelPl: "Spokojne źródła po polsku",
    labelEn: "Calm sources in Polish",
    textPl: "Wybierajcie materiały, które tłumaczą prosto, bez krzyku, sensacji i straszenia drugą stroną.",
    textEn: "Choose materials that explain simply, without shouting, sensationalism or frightening either side."
  },
  {
    id: "parent-pdf-video",
...
export const MUALLAF_SUPPORT_PANELS = [
  {
    ...
    bodyEn:
      "You do not need to know everything. Understand Tawhid, the meaning of shahada and the basics of prayer. Then you keep learning.",
    route: "pillars"
  },
  {
    id: "after-shahada",
  ...
  },
  {
    ...
    bodyEn:
      "Start from the relationship, not from an argument. Show that Islam is meant to make you better, not foreign.",
    route: "muallaf"
  }
];
